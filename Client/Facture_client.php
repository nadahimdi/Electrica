...
if(isset($_GET['live_search'])&&$_GET['live_search'] !== ""){
    ...
    $FactureData = $crudObject->getFactureClientDataSearch($client_id,$filtervalues);
    $pages = 1;
}


elseif (!isset($_GET['live_search']) || $_GET['live_search'] === ""){
$FactureData1 = $crudObject->getFactureClientData($client_id);
...
$FactureData = $crudObject->getFactureClientDataFetch($client_id,$startinglimit);}
?>
